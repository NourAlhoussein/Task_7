...
function SignupForm({ setShowSignup }: Props) {
  console.log("signup");
  return (
    <AnimatePresence>
      <motion.div
        ...
        >
          ...
          <div className="flex flex-col 2xl:gap-[20px] gap-[10px] mt-[20px] text-black/60">
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <div
                className="flex flex-row items-center justify-between bg-white border-1 border-black/20 rounded-[8px] 2xl:px-[24px] 2xl:py-[14px]
            px-[12px] py-[7px]"
              >
                <input
            ...
            <div className="flex flex-row items-center 2xl:gap-[10px] gap-[5px]">
              <Checkbox />
              <div className="text-black/60 text-sm">
                I agree with{" "}
                <span className="text-[#FA8B02] text-sm">Terms</span> and{" "}
                <span className="text-[#FA8B02] text-sm">Privacy</span>
              </div>
            </div>
            <button
          ...
          <div className="flex flex-row items-center justify-center 2xl:text-base text-xs font-semibold mt-[20px] text-black/60">
            ...
            <span className="text-[#FA8B02] ml-2 text-sm">Log In</span>
          </div>
        </motion.div>
      </motion.div>
    </AnimatePresence>
